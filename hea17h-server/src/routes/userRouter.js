...
userRouter.patch('/modifyUser', async function(req, res, next){
    try{
        const {id, name, password, gender, height, weight, goalWeight} = req.body;
        const updateUserInfo = {id, name, password, gender, height, weight, goalWeight};
        const afterUpdateUserInfo = await userService.updateUser(updateUserInfo);
...
userRouter.post('/signIn', async function (req, res, next){
    try{
        ...
        const newUser = await userService.addUser({
            id, name, password, gender, height, weight, goalWeight
        });
